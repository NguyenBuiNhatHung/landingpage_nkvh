    ...
    <div style="color: white;" class="section-title text-start">
        ...
        <div class="container">
            ...
            <div id="dathen" class="col-lg-6 wow fadeInRight" data-wow-delay="0.4s">
                <div style="background-color: white;" class="appointment-form rounded p-3">
                    <h5 style="color: rgb(26, 119, 224); text-align: center;font-family: Arial, Helvetica, sans-serif;"
                        class=" mb-4">ĐĂNG KÝ ĐỂ TRẢI NGHIỆM DỊCH VỤ ĐẲNG CẤP TẠI NHA KHOA VIỆT HÀN
                    </h5>
                    <form>
                        <div class="row gy-3 gx-4">
                            <div class="col-xl-12">
                                <input type="text"
                                    class="form-control py-1 border-primary bg-transparent text-white"
                            ...
                            <div class="col-xl-12">
                                <input type="email" class="form-control py-1 border-primary bg-transparent"
                                    placeholder="Email của bạn">
                            </div>
                            <div class="col-xl-12">
                                <input type="text" class="form-control py-1 border-primary bg-transparent"
                                    placeholder="Quốc gia">
                            </div>

                            <div class="col-xl-12">
                                <select name="service" class="form-select py-1 border-primary bg-transparent">
                            ...
                            <div class="col-xl-12">
                                <input type="date" class="form-control py-1 border-primary bg-transparent"
                                    placeholder="Thời gian đặt hẹn">
                                <p style="color: red;">(Thời gian đặt hẹn)</p>
                            </div>

                            <div class="col-12">
                                <button type="button" class="btn btn-primary text-white w-100 py-1 px-5">ĐẶT HẸN VỚI BÁC SĨ NGAY</button>
                            </div>
                        </div>
                    </form>
                </div>
