...
<div style="height: 400px;" class="container-fluid py-5 position-relative">
    ...
    <div class="container position-relative text-center text-black mt-5" style="z-index: 3;">
        <h4 style="font-weight: bold; font-family: Arial, Helvetica, sans-serif;" class=" mt-5">BAY VỀ VIỆT NAM KIẾN TẠO NỤ
            CƯỜI
            RẶNG RỠ CÙNG NHA KHOA VIỆT HÀN</h4>
        <p style="color:black;font-family: Arial, Helvetica, sans-serif;" class="lead mt-5">Đặt lịch hẹn tư vấn chuyên sâu và thăm khám miễn phí với
            các
            chuyên
            gia nha khoa hàng đầu của chúng tôi tại đây!</p>
        <a href="#" style="margin-top: 30px; color:white; height: 50px;font-family: Arial, Helvetica, sans-serif;" class="btn btn-primary btn-lg">LIÊN HỆ TƯ VẤN
            MIỄN PHÍ</a>
    </div>
</div>