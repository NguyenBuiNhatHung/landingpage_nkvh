...
<div class="text-center col-12 wow animate__animated animate__fadeInLeft">
    ...
    <div class="owl-carousel owl-cl col-10 mx-auto">
        <div class="cl p-4 border bg-white shadow custom-margin">
            <h5 class="nk-title-cl">1. Chuyên môn hàng đầu</h5>
        ...
        <div class="cl p-4 border bg-white shadow custom-margin">
            <h5 class="nk-title-cl">2. Sức khỏe bệnh nhân là ưu tiên tuyệt đối</h5>
        ...
        <div class="cl p-4 border bg-white shadow custom-margin">
            <h5 class="nk-title-cl">3. Tận tâm và trung thực</h5>
        ...
        <div class="cl p-4 border bg-white shadow custom-margin">
            <h5 class="nk-title-cl">4. Luôn đổi mới và phát triển</h5>
        ...
        <div class="cl p-4 border bg-white shadow custom-margin">
            <h5 class="nk-title-cl">5. Đề cao trách nhiệm xã hội</h5>
