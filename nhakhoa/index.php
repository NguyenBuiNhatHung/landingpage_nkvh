...
<body>
            ...
            <!-- <div class="header-carousel-item">
                ...
                <div class="carousel-caption">
                    <div class="carousel-caption-content p-3">
                        <h5 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Nha Khoa Việt
                            Hàn</h5>
    ...
    <div id="rangsu">
        <img class="w-100" src="img/rang-su.jpg" alt="">
    </div>

    <div>
        <img class="w-100 mt-1 mt-lg-3" src="img/banggia.jpg" alt="">
    </div>

    <div>
        <img class="w-100 mt-1 mt-lg-3" src="img/quytrinh.jpg" alt="">
    </div>

    <div id="implant">
        <img class="w-100 mt-1 mt-lg-3" src="img/implant.jpg" alt="">
    </div>

    <div>
        <img class="w-100 mt-1 mt-lg-3" src="img/khuyenmai.jpg" alt="">
    </div>
    <div>
        <img class="w-100 mt-1 mt-lg-3" src="img/implant2.jpg" alt="">
    </div>
                    ...
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                ...
                                <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore
                                    cum
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                    <div class="section-title text-start mb-5">
                        ...
                        <div class="mb-4">
                            <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Refresing to
                                get
                                such a personal touch.</p>
                            <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Duis aute
                                irure
                    ...
                    <div class="row-cols-1 feature-item p-4">
                        <div class="col-12">
                            ...
                            <div class="feature-content d-flex flex-column">
                                ...
                                <p class="mb-0">Dolor, sit amet consectetur adipisicing elit. Soluta inventore
                                    cum
                                    accusamus,</p>
                            </div>
                        </div>
    ...
    <div class="container-fluid py-5" style="background-color: #00AEEF;">
        ...
        <div style="height: 400px;" class="container-fluid py-5 position-relative">
            ...
            <div class="container position-relative text-center text-black mt-5" style="z-index: 3;">
                ...
                <a href="#" style="margin-top: 30px;" class="btn btn-primary btn-lg">ĐẶT HẸN NGAY</a>
            </div>
        </div>
